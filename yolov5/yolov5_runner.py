...
class YOLOV5Runner(BaseRKNN):
    def __init__(self, 
                 ...
                 score_thresh = 0.3,
                 data_format=['nhwc']):
        super(YOLOV5Runner, self).__init__(modelpath, async_mode, core, verbose, host_name=host_name, data_format=data_format)
        self.score_thresh = score_thresh
        
    def do_preprocess(self, src=None):
        print('[YOLOV5] preprocess')
